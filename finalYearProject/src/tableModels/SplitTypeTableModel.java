...
public class SplitTypeTableModel extends AbstractTableModel
{	
	private String [] columnNames;
	private Object [][] data;
		
	public SplitTypeTableModel(ResultSet rsIn)
	{		
		try
		{
			...
			//System.out.println("Constructor rowCount = "+rowCount);
	...
	{		
	    ...
	    {	      
	       ...
	       // System.out.println("col = "+columnNames[column-1]);
	    }
	    ...
	    while (rsIn.next()) 
	    {
	        ...
	        for (int columnIndex = 1; columnIndex <= columnCount; columnIndex++) 
	        {
	            ...
	            //System.out.print("data ="+data[rowIndex][columnIndex-1]);
	        }
	        System.out.println("");	       
	        rowIndex++;	      
	    }	  
