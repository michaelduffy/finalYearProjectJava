...
public class MainUI extends JFrame
{
	...
	public MainUI(String ipIn,String dbNameIn,String dbUserIn,String dbPassIn, String username, String userPass, boolean isSeriesDir, boolean isRaceDir)
	{
	    ...
	    op1= new OthersPanel(ipIn,dbNameIn,dbUserIn,dbPassIn,username,userPass,isSeriesDir);
		...
		if(isSeriesDir)
		{
			applicationTabs.add("Assign director", op1);
		}
		...
		if(isSeriesDir)
		{
			applicationTabs.setToolTipTextAt(5, "Add director to a race");
		}
